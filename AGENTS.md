...
- `frontend/src/components/ui/toaster.tsx`: `HiveToast` (custom toast card: status dot, mono status word, ghost action, hover close) + `HiveToaster` (bare Sonner wrapper, top-left)
