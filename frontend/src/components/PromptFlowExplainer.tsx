        ...
        <div className="z-10 flex flex-1 flex-col justify-center py-4">
          ...
          >
            ...
            <div className="flex-1 overflow-auto p-4 font-mono text-[11px] leading-relaxed">
              {mode === "chat" ? (
                <>
                  <PayloadBlock id="harness" hoveredId={hoveredCard} color="text-zinc-500">
                ...
                <>
                  ...
                  <PayloadBlock id="agent-base" hoveredId={hoveredCard} color="text-purple-400">
                    --append-system-prompt "You are a security reviewer...
                  </PayloadBlock>
                  <PayloadBlock id="agent-git" hoveredId={hoveredCard} color="text-green-400">
                    {`\n\n# Git Context\nProject: Hive\n...\n\n// omitted when no project is linked`}
                  </PayloadBlock>
                  <PayloadBlock id="agent-note" hoveredId={hoveredCard} color="text-zinc-500">
