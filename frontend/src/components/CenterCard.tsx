...
export function CenterCard({
  ...
  return (
    <div
      className={cn(
        "relative m-2 flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-border/60 bg-card shadow-[0_4px_16px_-6px_rgba(0,0,0,0.20),0_0_10px_-3px_rgba(0,0,0,0.10)]",
        className,
      )}
    >
